...
namespace DataAccess.Models
{
    public class Kisi : BaseClass
    {
        ...
        [Required(ErrorMessage = "Adres 1 alanı zorunludur."), MaxLength(100, ErrorMessage = "Adres 1 alanı 100 karakterden uzun olamaz.")]
        public string Adres1 { get; set; } = string.Empty;

        [MaxLength(100, ErrorMessage = "Adres 2 alanı 100 karakterden uzun olamaz.")]
